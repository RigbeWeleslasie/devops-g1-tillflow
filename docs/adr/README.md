...
| #    | Title                                   | Status   | DRI    |
| ---- | --------------------------------------- | -------- | ------ |
| 0001 | Record architecture decisions           | Accepted | Meron  |
| 0002 | AWS region: us-east-1                    | Accepted | Meron  |
| 0003 | Database: RDS PostgreSQL                 | Accepted | Meron  |
| 0004 | Object storage: one S3 bucket per purpose| Accepted | Meron  |
