...
| G4 2.9 (resource saturation) executed for real, not just asserted | 15-min k6 soak against the deployed target: checks 100%, `http_req_failed` 0%, p95 61ms, ~40 rps sustained at 15 VUs -- under the live edge throttle | [`g4-soak-drill.md`](g4-soak-drill.md) |
